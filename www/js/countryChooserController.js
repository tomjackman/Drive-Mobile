...
.controller('countryChooserController', function($scope, $stateParams, StorageService, $ionicHistory, $state, $rootScope) {
	...
	/**
	 * This method will save the chosen country to local storage.
	 */
	...
	$scope.next = function()
	{
		...
		{
			$state.go('app.dateOfBirthChooser');
		}
	}
